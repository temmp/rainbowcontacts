...
public class WifiClientTipsActivity extends Activity {
	...
	private Handler m_Handler=new Handler()
	{
		...
		public void handleMessage(Message msg)
		{
			...
			case 0:
				...
				break;
			case 1:
				m_TimeoutDialog=new AlertDialog.Builder(WifiClientTipsActivity.this){};
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.wifisend_tips_new);
		...
		m_OpenWifiProgress=new ProgressDialog(WifiClientTipsActivity.this){};
		...
		sharesend_text = (TextView)findViewById(R.id.sharesend_text_wifi_send_tips_new);
		sharesend_text1 = (TextView)findViewById(R.id.sharesend_text1_wifi_send_tips_new);
		sharesend_text2 = (TextView)findViewById(R.id.sharesend_text2_wifi_send_tips_new);
		sharesend_text3 = (TextView)findViewById(R.id.sharesend_text3_wifi_send_tips_new);
		skin_linearLayout = (LinearLayout)findViewById(R.id.ltest_wifi_send_tips_new);
		skin_linearLayout1 = (LinearLayout)findViewById(R.id.ltest1_wifi_send_tips_new);
		skin_linearLayout2 = (LinearLayout)findViewById(R.id.ltest2_wifi_send_tips_new);
		up_text = (TextView)findViewById(R.id.up_text_wifi_send_tips_new);
		down_text = (TextView)findViewById(R.id.down_text_wifi_send_tips_new);
		down_text1 = (TextView)findViewById(R.id.down_text1_wifi_send_tips_new);
		...
		sharesend_BackButton = (ImageButton)findViewById(R.id.sharesend_BackButton_wifi_send_tips_new);
		sharesend_NextButton = (ImageButton)findViewById(R.id.sharesend_NextButton_wifi_send_tips_new);
	...
	public void onokbtnwifisendnew(View view) {
		Intent i = new Intent(WifiClientTipsActivity.this,
	...
	protected void onResume() {
			...
			{
				m_OpenWifiDialog=new AlertDialog.Builder(WifiClientTipsActivity.this){};
