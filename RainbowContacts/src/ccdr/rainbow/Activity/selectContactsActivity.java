...
//		listMain.setOnScrollListener(this);
		...
		new jumpThread(mHandler).start();
		progressDialog = ProgressDialog.show(selectContactsActivity.this, getString(R.string.moment), getString(R.string.getdata), true);
...
//				disapearThread = new DisapearThread();
	...
	public void onexporttolocalbtn(View view) {
		...
		Intent i = new Intent(selectContactsActivity.this, exportContactsActivity.class);
...
(ContactsContract.CommonDataKinds.Phone.NUMBER));     
	...
	content = "Name:" + name + "\n"//
		...
		Dialog dialog = new Dialog(selectContactsActivity.this);
